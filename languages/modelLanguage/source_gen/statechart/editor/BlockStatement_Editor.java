...
public class BlockStatement_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_319n5h_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_319n5h_b0(editorContext, node));
  ...
  private EditorCell createRefNodeList_319n5h_b0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new BlockStatement_Editor.statementsListHandler_319n5h_b0(node, "statements", editorContext);
  ...
  private static class statementsListHandler_319n5h_b0 extends RefNodeListHandler {
    public statementsListHandler_319n5h_b0(SNode ownerNode, String childRole, EditorContext context) {
