...
public class PrimitiveType_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createAlternation_2lhshh_a0(EditorContext editorContext, SNode node) {
    ...
    if (alternationCondition) {
      ...
      editorCell = this.createConceptProperty_2lhshh_a0a(editorContext, node);
    }
    return editorCell;
  }
  ...
  private EditorCell createConceptProperty_2lhshh_a0a(EditorContext editorContext, SNode node) {
