...
public class typeof_TargetReference_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode nodeToCheck, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    SLinkOperations.setTarget(theType, "scope", SNodeOperations.getParent(SLinkOperations.getTarget(nodeToCheck, "state", false)), false);
    ...
    SPropertyOperations.set(theType, "toInitial", "" + (SPropertyOperations.getBoolean(SLinkOperations.getTarget(nodeToCheck, "state", false), "isInitial")));
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:e6b49452-7c70-4713-9029-6c9dda75fe0a(statechart.typesystem)", "7385576573236710363", 0, null);
      typeCheckingContext.createGreaterThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:e6b49452-7c70-4713-9029-6c9dda75fe0a(statechart.typesystem)", "7385576573236710366", true), (SNode) theType, false, false, _info_12389875345);
    }
  }
