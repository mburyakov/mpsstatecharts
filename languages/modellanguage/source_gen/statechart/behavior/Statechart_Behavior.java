...
public class Statechart_Behavior {
  ...
  public static List<SNode> call_simpleStates_2747754268221231605(SNode thisNode) {
    return ListSequence.fromList(Statechart_Behavior.call_mySimpleStates_2747754268221231852(thisNode)).concat(ListSequence.fromList(Statechart_Behavior.call_myComplexStates_2747754268221231933(thisNode)).translate(new ITranslator2<SNode, SNode>() {
      public Iterable<SNode> translate(SNode it) {
        return Statechart_Behavior.call_simpleStates_2747754268221231605(StatechartExpression_Behavior.call_getStatechart_2164628666946508700(SLinkOperations.getTarget(it, "structure", true)));
      }
    })).toListSequence();
  }
  ...
  public static List<SNode> call_complexStates_2747754268221235094(SNode thisNode) {
    return ListSequence.fromList(Statechart_Behavior.call_myComplexStates_2747754268221231933(thisNode)).concat(ListSequence.fromList(Statechart_Behavior.call_myComplexStates_2747754268221231933(thisNode)).translate(new ITranslator2<SNode, SNode>() {
      public Iterable<SNode> translate(SNode it) {
        return Statechart_Behavior.call_complexStates_2747754268221235094(StatechartExpression_Behavior.call_getStatechart_2164628666946508700(SLinkOperations.getTarget(it, "structure", true)));
      }
    })).toListSequence();
  }
  ...
  public static SNode call_singleInitial_2747754268221309514(SNode thisNode) {
    SNode msi = Statechart_Behavior.call_mySingleInitial_2747754268221309519(thisNode);
    return (msi == null ?
      null :
      (SLinkOperations.getTarget(msi, "structure", true) == null ?
        msi :
        Statechart_Behavior.call_singleInitial_2747754268221309514(StatechartExpression_Behavior.call_getStatechart_2164628666946508700(SLinkOperations.getTarget(msi, "structure", true)))
      )
    );
  }
  ...
  public static SNode call_singleFinal_2747754268221309910(SNode thisNode) {
    ...
    return (msf == null ?
      ...
      (SLinkOperations.getTarget(msf, "structure", true) == null ?
        msf :
        Statechart_Behavior.call_singleFinal_2747754268221309910(StatechartExpression_Behavior.call_getStatechart_2164628666946508700(SLinkOperations.getTarget(msf, "structure", true)))
      )
    );
  }
