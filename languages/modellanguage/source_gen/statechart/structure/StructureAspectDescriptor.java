...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  private static String[] stringSwitchCases_1htk8d_a0a0a = new String[]{"statechart.structure.Actor", "statechart.structure.BooleanType", "statechart.structure.Channel", "statechart.structure.EmptyStatement", "statechart.structure.IPureExpression", "statechart.structure.IStatement", "statechart.structure.IValidIdentifier", "statechart.structure.PrimitiveType", "statechart.structure.Scheme", "statechart.structure.State", "statechart.structure.Statechart", "statechart.structure.StatechartDeclaration", "statechart.structure.StatechartExpression", "statechart.structure.StatechartReference", "statechart.structure.TargetRefDotExpression", "statechart.structure.TargetRefExpression", "statechart.structure.TargetReference", "statechart.structure.TargetReferenceType", "statechart.structure.Transition", "statechart.structure.True"};
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0a, conceptFqName)) {
      ...
      case 9:
        return new CompiledConceptDescriptor("statechart.structure.State", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "statechart.structure.IValidIdentifier"}, new String[]{"isFinal", "isInitial"}, new String[]{});
      case 10:
        return new CompiledConceptDescriptor("statechart.structure.Statechart", "statechart.structure.StatechartExpression", false, new String[]{"statechart.structure.StatechartExpression", "jetbrains.mps.lang.core.structure.ScopeProvider"}, new String[]{}, new String[]{});
      case 11:
        return new CompiledConceptDescriptor("statechart.structure.StatechartDeclaration", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{}, new String[]{});
      case 12:
        return new CompiledConceptDescriptor("statechart.structure.StatechartExpression", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"}, new String[]{}, new String[]{});
      case 13:
        return new CompiledConceptDescriptor("statechart.structure.StatechartReference", "statechart.structure.StatechartExpression", false, new String[]{"statechart.structure.StatechartExpression"}, new String[]{}, new String[]{"declaration"});
      case 14:
      ...
      case 17:
        return new CompiledConceptDescriptor("statechart.structure.TargetReferenceType", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"}, new String[]{"toFinal", "toInitial"}, new String[]{"scope"});
      case 18:
