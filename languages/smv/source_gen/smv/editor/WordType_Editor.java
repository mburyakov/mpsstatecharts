...
public class WordType_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_yj0p5g_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_yj0p5g_b0(editorContext, node));
  ...
  private EditorCell createConstant_yj0p5g_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "word");
    editorCell.setCellId("Constant_yj0p5g_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
